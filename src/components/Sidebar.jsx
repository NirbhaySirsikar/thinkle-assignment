...
const Sidebar = () => {
  ...
  return (
    <aside className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
      ...
      <div className="nav-section">
        <div className={`nav-item ${location.pathname === '/creator' ? 'active' : ''}`}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <Link to="/submission" className={`nav-item ${location.pathname === '/submission' ? 'active' : ''}`}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <Link to="/refer" className={`nav-item ${location.pathname === '/refer' ? 'active' : ''}`}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
